       ...
       <div class="p-4 mt-14">
          <div class="relative items-center justify-center min-h-48 mb-4 rounded bg-white dark:bg-gray-800">
             <div class="p-8">
               ...
               <button type="button" data-modal-target="add-modal" data-modal-toggle="add-modal" class="text-white bg-blue-700 mb-4 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Artikel</button>
