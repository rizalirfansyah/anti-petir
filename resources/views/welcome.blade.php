...
<title>Penangkal Petir</title>
   ...
   <div class="max-w-4xl mx-auto">
    ...
    <div class="container max-h-screen max-w-full 2xl:w-full lg:w-full md:w-full sm:max-w-full bg-no-repeat overflow-hidden mx-auto">
        ...
        <div class="absolute animate__animated animate__fadeInLeft top-[360px] lg:top-80 w-[420px] h-12 ml-12 lg:ml-20 text-white">
    ...
    <div class="relative w-full h-[500px] overflow-hidden after:clear-both after:block after:content-['']">
        ...
        <img
            ...
            alt="Wild Landscape" />
            <div
            class="absolute top-40 inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
            <h5 class="text-xl">Testing</h5>
            <a href="" class="text-gray-200 text-xl animate__animated animate_fadeInLeft ">
