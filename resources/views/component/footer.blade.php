...
<footer
  ...
  <div class="bg-neutral-200 p-3 text-center dark:bg-neutral-700">
    <div class="w-full mx-auto max-w-screen-xl p-3 wow animate__fadeInUp">
        <span class="text-sm text-gray-500 text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">Anti-Petir</a>. All Rights Reserved.
        </span>
        </div>
  </div>
</footer>