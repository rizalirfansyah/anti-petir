...
<div class="fixed top-0 z-50 w-full mx-auto bg-white wow animate__fadeInDown">
    ...
    <nav class="border-gray-200 bg-slate-300">
    <div class="container relative flex flex-wrap items-center justify-between h-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
            <a href="/" class="block py-2 pl-3 pr-4 text-gray-700 hover:text-blue-700 rounded  md:p-0 focus:outline-none" aria-current="page">Home</a>
            </li>
            <li>
            ...
            <li>
            <a href="/refrensi" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Refrensi</a>
            </li>
            <li>
